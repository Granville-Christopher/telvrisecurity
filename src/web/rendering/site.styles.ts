...
export function renderDashboardTheme(): string {
  return `
    ...
    .dashboard-shell .overview-key-actions {
      display: flex;
      flex-wrap: wrap;
      gap: 10px;
    }

    .dashboard-shell .overview-latest-key {
      margin: 0;
    }
    ...
    .dashboard-shell .test-key-warning strong {
      color: #fcd34d;
    }
    ...
    .dashboard-shell .key-status-test {
      color: #fcd34d;
      background: rgba(234,179,8,0.14);
      border: 1px solid rgba(234,179,8,0.3);
    }
